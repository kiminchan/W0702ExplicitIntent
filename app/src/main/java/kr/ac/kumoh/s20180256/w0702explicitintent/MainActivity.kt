package kr.ac.kumoh.s20180256.w0702explicitintent
...
import kr.ac.kumoh.s20180256.w0702explicitintent.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.btnInplicitIntent.setOnClickListener {
            //Toast.makeText(this, "눌렸습니다.", Toast.LENGTH_SHORT).show()
